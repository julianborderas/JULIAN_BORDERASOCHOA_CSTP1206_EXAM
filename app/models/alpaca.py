class Alpaca(object):
    ...
    def __init__(self, id, name, displayName, bio, age, hobbies, contact, sex):
        self.id = id
        self.name = name
...
alpaca_user=Alpaca(id=None,name=None,displayName=None,bio=None,age=None, hobbies=None, contact=None, sex=None)